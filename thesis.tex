...
% NASA-TLX
\textit{NASA-TLX scores} suggest that participants found all of the different conditions equally difficult, as ANOVA showed no significant difference. This means that the degraded/high load trials were not difficult enough to be consciously perceived as such  by the participants.
...
\begin{table}[]
	...
	\begin{tabular}{@{}lll@{}}
		\toprule
		\textbf{metric}                                                                   & \textbf{ANOVA effects}                                                                                                                                                                                          & \textbf{descriptive statistics}                                                                                                                                                                                  \\ \midrule
		\begin{tabular}[c]{@{}l@{}}primary task\\ completion time\end{tabular}            & \begin{tabular}[c]{@{}l@{}}\textbf{load:} F(1,22) = 15.525,$p < .01$\\ \textbf{control mode:} F(1,22) = 40.377,$p < .01$\\ \textbf{interaction:} F(1,22) = 12.831, $p < .01$\\ $power > .9$\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{auto-high:} $M = 1153.8$ $sec$\\ \textbf{auto-low:} $M = 517.7$ $sec$\\ \textbf{teleop-high:} $M = 313.5$ $sec$\\ \textbf{teleop-low:} $M = 283.2$ $sec$\end{tabular} \\ \midrule
		collisions                                                                        & \begin{tabular}[c]{@{}l@{}}\textbf{load:} no effect\\ \textbf{control mode:} no effect\\ \textbf{interaction:} no effect\\ $power < .8$\end{tabular}                                                                                       & \begin{tabular}[c]{@{}l@{}}\textbf{auto-high:} $M = 7.6$ \\ \textbf{auto-low:} $M = 3.1$\\ \textbf{teleop-high:} $M = 2.7$\\ \textbf{teleop-low:} $M = 3.7$\end{tabular}                                                                             \\ \midrule
		\begin{tabular}[c]{@{}l@{}}primary task \\ score\end{tabular}                     & \begin{tabular}[c]{@{}l@{}}\textbf{load:} F(1,22) = 13.003,$p < .05$\\ \textbf{control mode:} F(1,22) = 33.067, $p < .01$\\ \textbf{interaction:} F(1,22) = 11.541, $p < .05$\\ $power > .9$\end{tabular}                                  & \textbf{auto-high:} $M = 1229.8$                                                                                                                                                                                          \\ \midrule
		\begin{tabular}[c]{@{}l@{}}secondary task \\ reaction time\end{tabular}           & \begin{tabular}[c]{@{}l@{}}\textbf{load:} no effect\\ \textbf{control mode:} no effect\\ \textbf{interaction:} F(1,22) = .4.638, $p < .05$\\ $power < .8$\end{tabular}                                                                     & \begin{tabular}[c]{@{}l@{}}\textbf{teleop-high:} $M = 0.588$ $sec$ \\ \textbf{teleop-low:} $M = 0.717$ $sec$\end{tabular}                                                                                                          \\ \midrule
		\begin{tabular}[c]{@{}l@{}}secondary task rate\\ of missed responses\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{load:} no effect\\ \textbf{control mode:} no effect\\ \textbf{interaction:} no effect\\ $power < .8$\end{tabular}                                                                                       &                                                                                                                                                                                                                  \\ \midrule
		NASA-TLX scores                                                                   & \begin{tabular}[c]{@{}l@{}}\textbf{load:} no effect\\ \textbf{control mode:} no effect\\ \textbf{interaction:} no effect\\ $power < .8$\end{tabular}                                                                                       &                                                                                                                                                                                                                  \\ \bottomrule
	\end{tabular}
	\caption{MUST ADD CAPTION!}
	\label{table:results_pilot}
\end{table}
...
\begin{table}[]
	...
	\begin{tabular}{lll}
		\hline
		\textbf{metric}                                                           & \textbf{ANOVA control mode effect}                                                                                                       & \textbf{descriptive statistics}                                                                                                                                                                     \\ \hline
		\begin{tabular}[c]{@{}l@{}}primary task\\ completion time\end{tabular}    & \begin{tabular}[c]{@{}l@{}}F(1.275, 28.057) = 34.567, $p < .01$,\\  $power > .9$, $\eta^2 = .61$\end{tabular}                            & \begin{tabular}[c]{@{}l@{}}HI: $M = 413.6$ $sec$, $SD = 33.7$\\ auto: $M = 483.9$ $sec$, $SD = 45.4$\\ teleop: $M = 429.6$ $sec$, $SD = 45.7$\end{tabular}                                          \\ \hline
		collisions                                                                & \begin{tabular}[c]{@{}l@{}}F(1.296, 28.507) = 9.173, $p < .05$,\\ $power > .85$, $\eta^2 = .29$\end{tabular}                             & \begin{tabular}[c]{@{}l@{}}HI: $M = .57$, $SD = .99$\\ auto: $M = .61$, $SD = .89$\\ teleop: $M = 2.43$, $SD = 2.78$\end{tabular}                                                                   \\ \hline
		\begin{tabular}[c]{@{}l@{}}primary task \\ score\end{tabular}             & \begin{tabular}[c]{@{}l@{}}F(1.336, 29.403) = 19.342, $p < .01$, \\ $power > .95$, $\eta^2 = .47$\end{tabular}                           & \begin{tabular}[c]{@{}l@{}}HI: $M = 419.2$, $SD = 35$\\ auto:$M = 490$, $SD = 47.93$\\ teleop: $M = 453.9$, $SD = 57.68$\end{tabular}                                                               \\ \hline
		\begin{tabular}[c]{@{}l@{}}secondary task \\ completion time\end{tabular} & \begin{tabular}[c]{@{}l@{}}$F(1.565, 34.420) = 7.821, p < .01,$\\  $power \textgreater .85$, $\eta^2 = .26\ $\end{tabular} & \begin{tabular}[c]{@{}l@{}}HI: $M = 39.3$ $sec$, $SD = 10.35$\\ auto: $M = 39.5$ $sec$, $SD = 12.32$\\ teleop: $M = 41.7$ $sec$, $SD = 16.5$\\ baseline: $M = 33.2$ $sec$, $SD = 5.52$\end{tabular} \\ \hline
		\begin{tabular}[c]{@{}l@{}}secondary task \\ errors\end{tabular}          & \begin{tabular}[c]{@{}l@{}}$F(3,66) = 1.452, p > .05,$\\ $power \textless .8$, $\eta^2 = .06\ $ \end{tabular}               & \begin{tabular}[c]{@{}l@{}}HI: $M = 1.63$, $SD = 1.49$ \\ auto:$M = 1.54$, $SD = 1.49$ \\ teleop: $M = 2.1$, $SD = 1.45$ \\ baseline: $M = 1.74$, $SD = 1.54$\end{tabular}                          \\ \hline
		\begin{tabular}[c]{@{}l@{}}NASA-TLX\\ scores\end{tabular}                 & \begin{tabular}[c]{@{}l@{}}$F(2,44) = 11.510, p < .01,$ \\ $power > .9$, $\eta^2 = .34$\end{tabular}                                     & \begin{tabular}[c]{@{}l@{}}HI: $M = 41.4$, $SD = 12.67$\\ auto: $M = 35.2$, $SD = 11.83$ \\ teleop: $M = 47.8$, $SD = 11.87$\end{tabular}                                                           \\ \hline
	\end{tabular}
	\caption{My caption}
	\label{table:results_exp2}
\end{table}
...
% NASA-TLX
Control mode had a significant effect on \textit{NASA-TLX scores} (see Fig. \ref{subfig:NASA-TLX_exp2_2}) as showed by ANOVA. Pairwise comparisons showed that RI was perceived by participants as having the lowest difficulty, as compared to HI variable autonomy mode with $p < 0.01$ and MI mode with $p = 0.05$. HI variable autonomy is perceived as being more difficult than MI ($p < 0.01$). 
...
\begin{table}[]
	...
	\begin{tabular}{lll}
		\hline
		\textbf{metric}                                                                 & \textbf{ANOVA control mode effect}                                                                               & \textbf{descriptive statistics}                                                                                                                                                        \\ \hline
		\begin{tabular}[c]{@{}l@{}}primary task\\ completion time\end{tabular}          & \begin{tabular}[c]{@{}l@{}}$F(2, 30) = 19.116$, $p < .01$,\\ $power = 1$, $\eta^2 = .56$\end{tabular}            & \begin{tabular}[c]{@{}l@{}}HI: $M = 418.5$ $sec$, $SD = 34.9$\\ MI: $M = 374.2$ $sec$, $SD = 15.6$ \\ RI: $M = 392.3$ $sec$, $SD = 22.4$\end{tabular}                                  \\ \hline
		collisions                                                                      & \begin{tabular}[c]{@{}l@{}}$F(1.469, 22.036) = 1$, $p > .05$, \\ $power < 0.8$, $\eta^2 = .062$\end{tabular}     & \begin{tabular}[c]{@{}l@{}}HI: $M = .63$, $SD = 1.1$ \\ MI: $M = 0.38$, $SD = 0.6$ \\ RI: $M = .81$, $SD = 1.5$\end{tabular}                                                           \\ \hline
		\begin{tabular}[c]{@{}l@{}}primary task \\ score\end{tabular}                   & \begin{tabular}[c]{@{}l@{}}$F(2, 30) = 16.774$, $p < .01$, \\ $power > 0.9$, $\eta^2 = .528$\end{tabular}        & \begin{tabular}[c]{@{}l@{}}HI: $M = 424.8$, $SD = 36.2$ \\ MI: $M = 378$, $SD = 18.7$ \\ RI: $M = 400.4$, $SD = 22.9$\end{tabular}                                                     \\ \hline
		\begin{tabular}[c]{@{}l@{}}secondary task \\ completion time\end{tabular}       & \begin{tabular}[c]{@{}l@{}}$F(3, 45) = 10.344$, $p < .01$, \\ $power > .95$, $\eta^2 = .408$\end{tabular}        & \begin{tabular}[c]{@{}l@{}}HI: $M = 40$ $sec$, $SD = 11.1$ \\ MI: $M = 34.5$ $sec$, $SD = 10.4$ \\ RI: $M = 33.2$ $sec$, $SD = 8.6$ \\ baseline: $M = 34$ $sec$, $SD = 6$\end{tabular} \\ \hline
		\begin{tabular}[c]{@{}l@{}}secondary task \\ errors\end{tabular}                & \begin{tabular}[c]{@{}l@{}}$F(3, 45) = 0.891$, $p > .05$, \\ $power < .8$, $\eta^2 = .056$\end{tabular}          & \begin{tabular}[c]{@{}l@{}}HI: $M = 1.7$, $SD = 1.67$ \\ MI: $M = 1.4$, $SD = 1.4$ \\ RI: $M = 2$, $SD = 1.67$ \\ baseline: $M = 1.7$, $SD = 1.7$\end{tabular}                         \\ \hline
		\begin{tabular}[c]{@{}l@{}}NASA-TLX\\ scores\end{tabular}                       & \begin{tabular}[c]{@{}l@{}}$F(1.337, 20.049) = 10.135$, $p < .01$, \\ $power > .9$, $\eta^2 = .403$\end{tabular} & \begin{tabular}[c]{@{}l@{}}HI: $M = 43.561$, $SD = 13.026$ \\ MI: $M = 33.217$, $SD = 13.399$ \\ RI: $M = 28.899$, $SD = 9.642$\end{tabular}                                           \\ \hline
		\begin{tabular}[c]{@{}l@{}}percentage of time \\ spent in autonomy\end{tabular} & \begin{tabular}[c]{@{}l@{}}$F(2, 25) = 0.74$, $p > .05$,\\ $power < .8$, $\eta^2 = .50$\end{tabular}             & \begin{tabular}[c]{@{}l@{}}HI: $M = 57.7\%$, $SD = 25.9$ \\ MI: $M = 53\%$, $SD = 23.25$ \\ RI: $M = 49.1\%$, $SD = 12.22$\end{tabular}                                                \\ \hline
		\begin{tabular}[c]{@{}l@{}}number of \\ LOA switches\end{tabular}               & \begin{tabular}[c]{@{}l@{}}$F(2, 30) = 16.78$, $p < .01$, \\ $power > .9$, $\eta^2 = .528$\end{tabular}          & \begin{tabular}[c]{@{}l@{}}HI: $M = 10.4$, $SD = 8.64$ \\ MI: $M = 13.6$, $SD = 11.78$ \\ RI: $M = 3.13$, $SD = 1.15$\end{tabular}                                                     \\ \hline
	\end{tabular}
	\caption{My caption}
	\label{table:results_exp2_2}
\end{table}
...
\begin{table}[]
	...
	\begin{tabular}{lll}
		\hline
		\textbf{metric}                                                           & \textbf{ANOVA control mode effect}                                                                               & \textbf{descriptive statistics}                                                                                                                               \\ \hline
		\begin{tabular}[c]{@{}l@{}}primary task\\ completion time\end{tabular}    & \begin{tabular}[c]{@{}l@{}}$F(2, 22) = 7.382$, $p < .01$, \\ $power > .9$, $\eta^2 = .402$\end{tabular}          & \begin{tabular}[c]{@{}l@{}}HI: $M = 327.9$ $sec$, $SD = 23.38$ \\ MI: $M = 349.5$ $sec$, $SD = 35.95$ \\ teleop: $M = 366.3$ $sec$, $SD = 36.26$\end{tabular} \\ \hline
		collisions                                                                & \begin{tabular}[c]{@{}l@{}}$F(2, 22) = .786$, $p > .05$,\\ $power < .8$, $\eta^2 = .067$,\end{tabular}           & \begin{tabular}[c]{@{}l@{}}HI: $M = 0.08$, $SD = .289$\\ MI: $M = 0.08$, $SD = .289$ \\ teleop: $M = 0.25$, $SD = 4.52$\end{tabular}                          \\ \hline
		\begin{tabular}[c]{@{}l@{}}primary task \\ score\end{tabular}             & \begin{tabular}[c]{@{}l@{}}$F(2, 22) = 8.724$, $p < .01$, \\ $power > .9$, $\eta^2 = .442$\end{tabular}          & \begin{tabular}[c]{@{}l@{}}HI: $M = 328.8$, $SD = 22.42$ \\ MI: $M = 350.3$, $SD = 34.9$ \\ teleop: $M = 368.8$, $SD = 35.57$\end{tabular}                    \\ \hline
		\begin{tabular}[c]{@{}l@{}}secondary task \\ completion time\end{tabular} & \begin{tabular}[c]{@{}l@{}}$F(2, 22) = 0.68$, $p > .05$, \\ $power > .85$, $\eta^2 = .058$\end{tabular}          & \begin{tabular}[c]{@{}l@{}}HI: $M = 54$ $sec$, $SD = 12.86$ \\ MI: $M = 54.8$ $sec$, $SD = 20.16$\\ teleop: $M = 60.3$ $sec$, $SD = 16.37$\end{tabular}       \\ \hline
		\begin{tabular}[c]{@{}l@{}}secondary task \\ errors\end{tabular}          & \begin{tabular}[c]{@{}l@{}}$F(2,22) = .789$, $p > .05$,\\ $power < .8$,  $\eta^2 = .067$\end{tabular}            & \begin{tabular}[c]{@{}l@{}}HI: $M = .83$, $SD = 1.03$ \\ MI: $M = 1.5$, $SD = 1.314$ \\ teleop: $M = 1.42$, $SD = 1.62$\end{tabular}                          \\ \hline
		\begin{tabular}[c]{@{}l@{}}NASA-TLX\\ scores\end{tabular}                 & \begin{tabular}[c]{@{}l@{}}$F(1.263,13.896) = 5.001$, $p < .05$, \\ $power = .603$, $\eta^2 = .313$\end{tabular} & \begin{tabular}[c]{@{}l@{}}HI: $M = 25.9$, $SD = 12.39$ \\ MI: $M = 29.9$, $SD = 14.94$ \\ teleop: $M = 38.9$, $SD = 17.4$\end{tabular}                       \\ \hline
		\begin{tabular}[c]{@{}l@{}}number of \\ LOA switches\end{tabular}         & $t(11) = -4.076 , p < 0.01$                                                                                      & \begin{tabular}[c]{@{}l@{}}HI: $M = 9.08$, $SD = 3.42$ \\ MI: $M = 15.08$, $SD = 5.73$\\controller in MI: $M = 3.42$, $SD = 1.83$\end{tabular}           \\ \hline
	\end{tabular}
	\caption{My caption}
	\label{table:results_exp_3}
\end{table}
